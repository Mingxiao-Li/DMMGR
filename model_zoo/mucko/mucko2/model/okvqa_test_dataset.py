...
class OkvqaTestDataset(Dataset):
    def __init__(self, config, overfit=False, in_memory=True):
        ...
        img_data = np.load('okvqa/val_image_feature20.npz')
        ...
        sem_data = np.load('okvqa/semantic_graph_val_feature20.npz')
        ...
        fact_data = np.load('okvqa/fact_graph_val_feature20.npz')
